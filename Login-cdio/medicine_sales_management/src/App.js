    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path={"/inputWarehouse/list"}
            element={<InputWarehouseList />}
          ></Route>
          <Route
            path={"/inputWarehouse/create"}
            element={<InputWarehouseCreate />}
          ></Route>
          <Route
            path={"/inputWarehouse/update/:id"}
            element={<InputWarehouseUpdate />}
          ></Route>
          ...
          <Route
            path={"/typeMedicine/list"}
            element={<TypeMedicineList />}
          ></Route>
          <Route
            path={"/typeMedicine/create"}
            element={<TypeMedicineCreate />}
          ></Route>
        </Routes>
        <ToastContainer />
      </BrowserRouter>
